...
const HomeScreen = ({navigation}) =>{
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <Text style={styles.text1}>{greetingMessage}, {displayName}</Text>
        ...
        <Text style={{width:300, marginTop:170, textAlign:"center"}}>"Turning Drops into Dreams and Watts into Wonders: Nurturing a Greener Future."</Text>
